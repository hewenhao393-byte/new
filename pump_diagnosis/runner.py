...
from pump_diagnosis.metadata import build_file_index, split_file_index
...
def main() -> None:
    ...
    parser.add_argument(
        "--stage",
        choices=["inspect", "split", "preprocess", "features", "select", "train", "evaluate", "all"],
        required=True,
    )
